...
[_LOWER] = {
  ...
  {KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_LCBR, KC_RCBR, KC_UNDS, KC_PLUS, KC_PIPE},
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, RESET,   KC_HOME},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_END }
},
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Win  | Alt  |      |      |             |      | Play | Prev | Next | PgDn |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = {
  ...
  {KC_RCTL, KC_RGUI, KC_RALT, _______, _______, _______, _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, KC_PGDN}
},
